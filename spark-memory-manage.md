...
图 1 . 堆内和堆外内存示意图
![](/assets/on-heap-off-heap-memory.png)
...
图 2. 静态内存管理图示——堆内
![](/assets/on-heap-static-memory-manage.png)
...
图 3. 静态内存管理图示——堆外
![](/assets/off-heap-static-memory-manage.png)
...
图 4. 统一内存管理图示——堆内
![](/assets/on-heap-unified-memory-manage.png)

图 5. 统一内存管理图示——堆外
![](/assets/off-heap-unified-memory-manage.png)
...
图 6. 动态占用机制图示
![](/assets/dynamic-occupation-mechanism.png)
